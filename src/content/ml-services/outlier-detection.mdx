...
| Dataset Size | Dimensions | Recommended Algorithm | Reason |
|--------------|------------|----------------------|---------|
| < 10K rows | < 10 | Z-Score, IQR | Fast, simple |
| 10K-1M rows | 10-50 | Isolation Forest | Efficient, accurate |
| 1M-10M rows | 50-100 | Isolation Forest, LOF | Scalable |
| > 10M rows | > 100 | Autoencoder, Ensemble | Complex patterns |
